...
static {
  ...
  @SuppressWarnings({"unchecked","rawtypes"}) public static <T>T cast(  Object obj,  Class<T> clazz,  ParserConfig config){
    if (obj == null) {
      if (clazz == int.class) {
  ...
  @SuppressWarnings("unchecked") public static <T>T cast(  Object obj,  Type type,  ParserConfig mapping){
    if (obj == null) {
      return null;
    }
      ...
      }
{
  ...
  public static void addBaseClassMappings(){
    ...
    String[] w=new String[]{"java.util.Collections$UnmodifiableMap"};
  ...
  public static List<FieldInfo> getFieldInfos(  Class<?> clazz,  boolean sorted,  Map<String,FieldInfo> fieldInfoMap){
  ...
  public static void computeFields(  Class<?> clazz,  Map<String,String> aliasMap,  PropertyNamingStrategy propertyNamingStrategy,  Map<String,FieldInfo> fieldInfoMap,  Field[] fields){
  ...
  public static String getPropertyNameByCompatibleFieldName(  Map<String,Field> fieldCacheMap,  String methodName,  String propertyName,  int fromIdx){
 ...
 */
  ...
  public static Type getCollectionItemType(  Class<?> clazz){
  ...
  public static Type getCollectionSuperType(  Class<?> clazz){
  ...
  public static Map<TypeVariable,Type> createActualTypeMap(  TypeVariable[] typeParameters,  Type[] actualTypeArguments){
  ...
  public static ParameterizedType makeParameterizedType(  Class<?> rawClass,  Type[] typeParameters,  Map<TypeVariable,Type> actualTypeMap){
    int length=typeParameters.length;
  ...
  public static Type getActualType(  Type typeParameter,  Map<TypeVariable,Type> actualTypeMap){
