...
public class JavaBeanInfo {
  ...
  public int defaultConstructorParameterSize;
  public FieldInfo[] fields;
  public FieldInfo[] sortedFields;
  ...
  public static FieldInfo getField(  List<FieldInfo> fieldList,  String propertyName){
  ...
  public static boolean add(  List<FieldInfo> fieldList,  FieldInfo field){
  ...
  public static void computeFields(  Class<?> clazz,  Type type,  PropertyNamingStrategy propertyNamingStrategy,  List<FieldInfo> fieldList,  Field[] fields){
  ...
  public static Constructor<?> getDefaultConstructor(  Class<?> clazz,  final Constructor<?>[] constructors){
  ...
  public static Method getFactoryMethod(  Class<?> clazz,  Method[] methods,  boolean jacksonCompatible){
    Method factoryMethod=null;
    for (    Method method : methods) {
      if (!Modifier.isStatic(method.getModifiers())) {
        continue;
