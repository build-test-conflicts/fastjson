 ...
 */
  ...
  void write(  JSONSerializer serializer,  Object object,  Object fieldName,  Type fieldType,  int features,  boolean unwrapped) throws IOException {
    ...
    try {
      ...
      if ((this.beanInfo.features & SerializerFeature.WriteClassName.mask) != 0 || (features & SerializerFeature.WriteClassName.mask) != 0 || serializer.isWriteClassName(fieldType,object)) {
      ...
      for (int i=0; i < getters.length; ++i) {
        ...
        if (beanInfo.typeKey != null && fieldInfoName.equals(beanInfo.typeKey) && serializer.isWriteClassName(fieldType,object)) {
          continue;
        }
        ...
        if (propertyValue != null && (out.notWriteDefaultValue || (fieldInfo.serialzeFeatures & SerializerFeature.NotWriteDefaultValue.mask) != 0 || (beanInfo.features & SerializerFeature.NotWriteDefaultValue.mask) != 0)) {
          Class<?> fieldCLass=fieldInfo.fieldClass;
  ...
  protected boolean isWriteAsArray(  JSONSerializer serializer,  int fieldFeatrues){
    ...
    return (beanInfo.features & mask) != 0 || serializer.out.beanToArray || (fieldFeatrues & mask) != 0;
  }
